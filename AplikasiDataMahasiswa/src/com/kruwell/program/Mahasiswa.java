...
public class Mahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbKelas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "D3 TI 1A", "D4 TI 1A", "D4 TI 1B" }));
        cbKelas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbKelasActionPerformed(evt);
            }
        });
        getContentPane().add(cbKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 155, 185, -1));
    ...
    private void tbSimpanActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
        try{
            String sql = "INSERT INTO mahasiswa VALUES ('"+txtNIM.getText()+"','"+txtNama.getText()+"','"+cbKelas.getSelectedItem()+"','"+txtAlamat.getText()+"','"+txtEmail.getText()+"','"+txtTelp.getText()+"')";
            java.sql.Connection conn = (Connection)Konfig.configDB();
    ...
    private void tabelMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {                                           
        ...
        String nik = tabelMahasiswa.getValueAt(baris, 1).toString();
        txtNIM.setText(nik);
    ...
    private void tbEditActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        try{
            String sql = "UPDATE mahasiswa SET nim='"+txtNIM.getText()+"',nama='"+txtNama.getText()+"',kelas='"+cbKelas.getSelectedItem()+"',alamat='"+txtAlamat.getText()+"',email='"+txtEmail.getText()+"',no_telp='"+txtTelp.getText()+"' WHERE nim = '"+txtNIM.getText()+"'";
            java.sql.Connection conn = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
